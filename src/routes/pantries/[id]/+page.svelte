...
<main>
	...
	{#if $user?.uid == pantry.owner} <!--this is only for owners-->
	...
	<div id="share">
		...
		<img bind:this={qrCodeImage} alt="QR code" width="200" /><a href={qrCodeImage?.src} download>Download QRCode as image</a>
	</div>
</main>
